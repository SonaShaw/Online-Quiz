	...
	<div class = "col-sm-6">
		...
		<div class="panel panel-primary" >
			...
			<div class = "panel-body">
				...
				echo $_SESSION['qset']."<br>";
				echo $_SESSION['cat'];

				?>
			<form action="../../final_page.php" method = "post">	
				<div align = "center">
				<button type="submit" class="btn btn-default" name = "nextButton" style="width: 200px; height: 50px;"><font face = "Times New Roman" size="3"><b>FINISH</b></font></button>
				</div>
			</form>
			</div>
		</div>
