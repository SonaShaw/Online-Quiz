...
<div class="container" >
	...
	<div class = "col-sm-6">
		<br>
		<div class="panel panel-primary" >
			<div class = "panel-heading" align = "center" style="background-color:#081450;"><font face = "Times New Roman"><h3><b>Candidate Login</b></h3></font>
			</div>
			...
			if(isset($_GET['run']) && $_GET['run']=="failed"){
				...
				echo "<script type='text/javascript'>
						alert('$message'); 
						window.location.href='page 1 adminLogin.php'; 
