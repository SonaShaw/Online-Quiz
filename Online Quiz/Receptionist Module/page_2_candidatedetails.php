...
<body onload = "changeFont('cnum')">
	...
	<div class = "col-sm-6">
		...
		<div class="panel panel-primary" >
			<div class = "panel-heading" align = "center"  style="background-color:#081450;"><font face = "Times New Roman"><h3><b>Enter Candidate Details</b></h3></font>
			</div>
		</div>
		<!-------------------->
		...
		<form action="add candidate.php" method = "post"  onsubmit = "return Validate()">
			<table class ="rounded_corner">
				...
				<tr>
					...
					<div class="">
						<td>			
							<select ID = "source" name = "source" onchange="populate(this.id,'subsource');showSpanForSource('source','subsource','consultancy','textbox');changeFont(this.id)">
								<OPTION value = ""></option>
				...
				<tr>
					...
					<div class="" >
						<td>						
							<input id = "yesca" type="radio" name="ca" value = "YES" onchange = "identifyQsSetByCA(this.id,'qsset'); changeFont('qsset');setDeptToAccounting('department','profile')" AUTOFOCUS REQUIRED> <label><font face = "Times New Roman" size = "3">Yes</font></label> &nbsp &nbsp 
							<input id="noca" type="radio" name="ca" value = "NO" onchange = "identifyQsSetByCA('yesca','qsset'); changeFont('qsset');unsetDeptToAccounting('department','profile')" AUTOFOCUS REQUIRED><label><font face = "Times New Roman" size = "3">No</font></labe>
						</td>
					</div>
				</tr>
				<tr>
					...
					<div>
						<td>			
							<select ID = "department" name = "department" onchange="populate('department','profile'); changeFont(this.id);setQsSetbyDept(this.id,'qsset')">
								<OPTION value = ""></option>
